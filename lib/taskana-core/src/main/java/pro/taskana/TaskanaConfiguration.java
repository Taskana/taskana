...
public class TaskanaConfiguration {
  ...
  public static class Builder {
    ...
    private Duration jobLockExpirationPeriod = Duration.ofMinutes(1);
    ...
    private Duration taskCleanupJobLockExpirationPeriod = Duration.ofMinutes(1);
    ...
    private Duration workbasketCleanupJobLockExpirationPeriod = Duration.ofMinutes(1);
    ...
    private Duration simpleHistoryCleanupJobLockExpirationPeriod = Duration.ofMinutes(1);
    ...
    private Duration taskUpdatePriorityJobLockExpirationPeriod = Duration.ofMinutes(1);
    ...
    private Duration userRefreshJobLockExpirationPeriod = Duration.ofMinutes(1);
