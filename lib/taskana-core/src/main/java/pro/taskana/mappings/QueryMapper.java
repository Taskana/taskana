...
public interface QueryMapper {
    ...
    @Select("<script> "
        ...
        + "<if test=\"joinWithAttachmentsOrderBy\">"
        + ", ACLASSIFICATION_ID, ACLASSIFICATION_KEY, ACHANNEL, AREF_VALUE, ARECEIVED"
        + "</if>"
        + " ) "
        ...
        + "<choose>"
        + "<when test=\"item.contains('a.CLASSIFICATION_ID ASC')\">"
        + "ACLASSIFICATION_ID ASC"
        + "</when>"
        + "<when test=\"item.contains('a.CLASSIFICATION_ID DESC')\">"
        + "ACLASSIFICATION_ID DESC"
        + "</when>"
        + "<when test=\"item.contains('a.CLASSIFICATION_KEY ASC')\">"
        + "ACLASSIFICATION_KEY ASC"
        + "</when>"
        + "<when test=\"item.contains('a.CLASSIFICATION_KEY DESC')\">"
        + "ACLASSIFICATION_KEY DESC"
        + "</when>"
        + "<when test=\"item.contains('a.CHANNEL ASC')\">"
        + "ACHANNEL ASC"
        + "</when>"
        + "<when test=\"item.contains('a.CHANNEL DESC')\">"
        + "ACHANNEL DESC"
        + "</when>"
        + "<when test=\"item.contains('a.REF_VALUE ASC')\">"
        + "AREF_VALUE ASC"
        + "</when>"
        + "<when test=\"item.contains('a.REF_VALUE DESC')\">"
        + "AREF_VALUE DESC"
        + "</when>"
        + "<when test=\"item.contains('a.RECEIVED ASC')\">"
        + "ARECEIVED ASC"
        + "</when>"
        + "<when test=\"item.contains('a.RECEIVED DESC')\">"
        + "ARECEIVED DESC"
        + "</when>"
        + "<otherwise>"
        + "${item}"
