...
/**
 * The SingleRow represents a single row in a {@linkplain Report}. It contains an array of cells
 * whose index corresponds to the {@linkplain ColumnHeader} index in the {@linkplain Report}.
 *
