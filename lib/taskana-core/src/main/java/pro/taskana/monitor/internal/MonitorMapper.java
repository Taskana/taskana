...
public interface MonitorMapper {
  ...
  @Select(
      "<script>"
          ...
          + "<if test=\"_databaseId == 'oracle'\">SELECT T.WORKBASKET_KEY, (TRUNC(T.${timestamp}) - TRUNC(CURRENT_TIMESTAMP)) as AGE_IN_DAYS </if> "
          ...
          + "FROM TASK "
          + "<if test=\"_databaseId != 'oracle'\">AS </if> "
          + "T LEFT JOIN ATTACHMENT "
          + "<if test=\"_databaseId != 'oracle'\">AS </if> "
          + "A ON T.ID = A.TASK_ID "
          + "<where>"
  ...
  @Select(
      "<script>"
          ...
          + "<if test=\"_databaseId == 'oracle'\">SELECT CLASSIFICATION_CATEGORY, (TRUNC(${timestamp}) - TRUNC(CURRENT_TIMESTAMP)) as AGE_IN_DAYS </if> "
  ...
  @Select(
      "<script>"
          ...
          + "<if test=\"_databaseId == 'oracle'\">SELECT CLASSIFICATION_KEY, (TRUNC(${timestamp}) - TRUNC(CURRENT_TIMESTAMP)) as AGE_IN_DAYS </if> "
  ...
  @Select(
      "<script>"
          ...
          + "<if test=\"_databaseId == 'oracle'\">SELECT T.CLASSIFICATION_KEY as TASK_CLASSIFICATION_KEY, A.CLASSIFICATION_KEY as ATTACHMENT_CLASSIFICATION_KEY, (TRUNC(T.${timestamp}) - TRUNC(CURRENT_TIMESTAMP)) as AGE_IN_DAYS </if> "
  ...
  @Select(
      "<script>"
          ...
          + "<if test=\"_databaseId == 'oracle'\">SELECT ${customField} as CUSTOM_FIELD, (TRUNC(${timestamp}) - TRUNC(CURRENT_TIMESTAMP)) as AGE_IN_DAYS </if> "
  ...
  @Select(
      "<script>"
          ...
          + "#{selectedItem.upperAgeLimit} >= (TRUNC(${timestamp}) - TRUNC(CURRENT_TIMESTAMP)) AND "
          + "#{selectedItem.lowerAgeLimit} &lt;= (TRUNC(${timestamp}) - TRUNC(CURRENT_TIMESTAMP)) "
          + "</if> "
  ...
  @Select(
      "<script>"
          ...
          + "<if test=\"_databaseId == 'oracle'\">(TRUNC(T.${status}) - TRUNC(CURRENT_TIMESTAMP))</if>"
          ...
          + "FROM TASK "
          + "<if test=\"_databaseId != 'oracle'\">AS </if> "
          + "T INNER JOIN WORKBASKET "
          + "<if test=\"_databaseId != 'oracle'\">AS </if> "
          + "W ON T.WORKBASKET_KEY=W.KEY "
          + "<where>"
