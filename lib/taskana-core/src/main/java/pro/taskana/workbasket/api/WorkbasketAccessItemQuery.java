...
public interface WorkbasketAccessItemQuery
   ...
   * WorkbasketAccessItem#getId()} value that is equal to any of the passed values.
   *
  ...
  /**
   * Selects only {@linkplain WorkbasketAccessItem WorkbasketAccessItems} which have a {@linkplain
   * WorkbasketAccessItem#getWorkbasketId()} value that is equal to any of the passed values.
   *
  ...
  /**
   * Selects only {@linkplain WorkbasketAccessItem WorkbasketAccessItems} which have a {@linkplain
   * WorkbasketAccessItem#getWorkbasketKey()} value that is equal to any of the passed values.
   *
  ...
  /**
   * Selects only {@linkplain WorkbasketAccessItem WorkbasketAccessItems} which have a {@linkplain
   * WorkbasketAccessItem#getWorkbasketKey()} value that contains any of the passed patterns.
   *
  ...
  /**
   * Selects only {@linkplain WorkbasketAccessItem WorkbasketAccessItems} which have a {@linkplain
   * WorkbasketAccessItem#getAccessId()} value that is equal to any of the passed values.
   *
   ...
   * WorkbasketAccessItem#getAccessId()} value that contains any of the passed patterns.
   *
   * <p>Behind this method the SQL LIKE operator is used. SQL LIKE wildcard characters will be
   * resolved correctly.
   *
