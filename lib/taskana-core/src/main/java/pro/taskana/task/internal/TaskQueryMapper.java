...
import pro.taskana.task.internal.util.TaskQueryMapperQueryProvider;

/** This class provides a mapper for all task queries. */
@SuppressWarnings({"checkstyle:LineLength", "checkstyle:Indentation"})
public interface TaskQueryMapper {

  @SelectProvider(type = TaskQueryMapperQueryProvider.class, method = "getSelectTaskSummariesQuery")
  @Results(
      id = "taskSummaryResult",
      value = {
  ...
  @SelectProvider(type = TaskQueryMapperQueryProvider.class, method = "getSelectTaskSummariesDb2Query")
  @ResultMap("taskSummaryResult")
  List<TaskSummaryImpl> queryTaskSummariesDb2(TaskQueryImpl taskQuery);

  @SelectProvider(type = TaskQueryMapperQueryProvider.class, method = "getObjectReferencesQuery")
  @Results({
    @Result(property = "id", column = "ID"),
  ...
  @SelectProvider(type = TaskQueryMapperQueryProvider.class, method = "getCountTaskSummariesQuery")
  Long countQueryTasks(TaskQueryImpl taskQuery);

  @SelectProvider(type = TaskQueryMapperQueryProvider.class, method = "getCountTaskSummariesDb2Query")
  Long countQueryTasksDb2(TaskQueryImpl taskQuery);

  @SelectProvider(type = TaskQueryMapperQueryProvider.class, method = "getCountObjectReferencesQuery")
  Long countQueryObjectReferences(ObjectReferenceQueryImpl objectReference);

  @SelectProvider(type = TaskQueryMapperQueryProvider.class, method = "getTaskColumnValuesQuery")
  List<String> queryTaskColumnValues(TaskQueryImpl taskQuery);

  @SelectProvider(type = TaskQueryMapperQueryProvider.class, method = "getObjectReferenceColumnValuesQuery")
