...
public interface TaskService {
  ...
  /**
   * Transfers a {@linkplain Task} to another {@linkplain Workbasket} and set owner of the
   ...
   * Task} in new {@linkplain Workbasket} to owner while always setting {@linkplain
   ...
   * owner while always setting {@linkplain Task#isTransferred isTransferred} to true.
   *
   * @param destinationWorkbasketId {@linkplain Workbasket#getId() id} of the target {@linkplain
   *     Workbasket}
   * @param taskIds List of source {@linkplain Task Tasks} which will be moved
