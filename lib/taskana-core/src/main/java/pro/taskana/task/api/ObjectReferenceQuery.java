...
public interface ObjectReferenceQuery
   ...
   * ObjectReference#getCompany() company} value that is equal to any of the passed values.
   *
  ...
  /**
   * Selects only {@linkplain ObjectReference ObjectReferences} which have a {@linkplain
   * ObjectReference#getSystem() system} value that is equal to any of the passed values.
   *
  ...
  /**
   * Selects only {@linkplain ObjectReference ObjectReferences} which have a {@linkplain
   * ObjectReference#getSystemInstance() system instance} value that is equal to any of the passed
   * values.
   *
  ...
  /**
   * Selects only {@linkplain ObjectReference ObjectReferences} which have a {@linkplain
   * ObjectReference#getType() type} value that is equal to any of the passed values.
   *
  ...
  /**
   * Selects only {@linkplain ObjectReference ObjectReferences} which have a {@linkplain
   * ObjectReference#getValue() value} that is equal to any of the passed values.
   *
