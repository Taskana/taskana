...
public class GetTaskAccTest extends AbstractAccTest {
    ...
    public void testGetTaskById() throws TaskNotFoundException, NotAuthorizedException, InvalidArgumentException {
        ...
        assertEquals(Instant.parse("2018-01-29T14:55:00Z").atZone(ZoneId.systemDefault()), task.getCreated().atZone(ZoneId.systemDefault()));
        assertEquals(Instant.parse("2018-01-30T14:55:00Z").atZone(ZoneId.systemDefault()), task.getClaimed().atZone(ZoneId.systemDefault()));
        assertEquals(Instant.parse("2018-01-30T14:55:00Z").atZone(ZoneId.systemDefault()), task.getModified().atZone(ZoneId.systemDefault()));
        assertEquals(Instant.parse("2018-01-29T14:55:00Z").atZone(ZoneId.systemDefault()), task.getPlanned().atZone(ZoneId.systemDefault()));
        assertEquals(Instant.parse("2018-01-30T14:55:00Z").atZone(ZoneId.systemDefault()), task.getDue().atZone(ZoneId.systemDefault()));
