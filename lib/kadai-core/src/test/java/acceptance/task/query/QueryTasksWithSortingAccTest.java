  ...
  class SortingTest {
    ...
    class Creator {
      ...
      void should_ReturnOrderedResult_When_OrderByCreatorDescIsSet() {
        List<TaskSummary> results =
            kadaiEngine.getTaskService().createTaskQuery().orderByCreator(DESCENDING).list();
    ...
    class OwnerLongName {
      ...
      void should_OrderByOwnerLongNameDesc() {
        List<TaskSummary> results =
            kadaiEngine.getTaskService().createTaskQuery().orderByOwnerLongName(DESCENDING).list();
        assertThat(results)
      ...
      void should_OrderByOwnerLongNameAsc() {
        List<TaskSummary> results =
            kadaiEngine.getTaskService().createTaskQuery().orderByOwnerLongName(ASCENDING).list();
        assertThat(results)
            .filteredOn(r -> nonNull(r.getOwnerLongName()))
            .hasSizeGreaterThan(2)
            .extracting(TaskSummary::getOwnerLongName)
    ...
    class WorkbasketId {
      ...
      void should_ReturnOrderedResult_When_OrderByWorkbasketIdDescIsSet() {
        List<TaskSummary> results =
            kadaiEngine.getTaskService().createTaskQuery().orderByWorkbasketId(DESCENDING).list();
