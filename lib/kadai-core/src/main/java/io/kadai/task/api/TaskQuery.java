...
public interface TaskQuery extends BaseQuery<TaskSummary, TaskQueryColumnName> {
   ...
   *
   * @param isRead as Boolean. If null, it won't be integrated into the statement. It will only be
   *     integrated into the statement if set to true or false
   * @return the query
   */
   ...
   *
   * @param lockResults determines the number of returned and locked results; if zero, no results
   *     are locked, but the number of returned results is not limited
   * @return the query
   */
