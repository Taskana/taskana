...
public interface Task extends TaskSummary {
   ...
   * is used predominantly by the kadai adapter. It controls synchronization between kadai and the
   * external system.
   */
   ...
   * externalId can only be set before the Task is inserted. Kadai rejects attempts to modify
   * externalId.
   *
   ...
   * io.kadai.workbasket.api.models.Workbasket Workbasket} of the Task - selects the appropriate
   ...
   * io.kadai.workbasket.api.models.Workbasket Workbasket} where the Task is stored in.
   *
