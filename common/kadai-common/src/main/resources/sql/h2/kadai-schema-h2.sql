...
-- Moved to h2 jdbc connect string, because of kadai-spring-example project is using two schemas.
-- There the order of the schema setup's (dbcustom, kadai) should be switched then we can set collation
-- here in this file!
