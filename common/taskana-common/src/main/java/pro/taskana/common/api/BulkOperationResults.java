...
/**
 * The BulkOperationResults contains exceptions for a bulk db interaction with errors. This wrapper
 * is storing them with a matching object ID.
 *
...
public class BulkOperationResults<K, V extends Exception> {
   ...
   *
   * @param objectId unique key of an entity
   * @param error occurred error of an interaction with the entity
   */
