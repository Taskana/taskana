...
-- The script needs to be reviewed and adapted for each individual TASKANA setup.
-- ===========================
-- index[3],    0,056MB
CREATE INDEX "IDX_Classification" ON "CLASSIFICATION"
...
COMMIT WORK ;
-- index[1],    0,013MB
CREATE UNIQUE INDEX "IDX_ClassificationId"
   ON "CLASSIFICATION" ("ID" ASC) INCLUDE
...
COMMIT WORK ;
-- index[11],    0,056MB
CREATE UNIQUE INDEX "IDX_ClassificationIdWithModified"
   ON "CLASSIFICATION" ("ID" ASC) INCLUDE
   ("CUSTOM_8", "CUSTOM_7", "CUSTOM_6", "CUSTOM_5", "CUSTOM_4",
   "CUSTOM_3", "CUSTOM_2", "CUSTOM_1", "APPLICATION_ENTRY_POINT",
   "SERVICE_LEVEL", "PRIORITY", "DESCRIPTION", "NAME",
...
COMMIT WORK ;
-- index[8],    0,056MB
CREATE UNIQUE INDEX "IDX_ClassificationKeyDomain"
   ON "CLASSIFICATION" ("KEY" ASC, "DOMAIN"
...
-- index[2],    3,646MB
   CREATE INDEX "IDX_TaskKeyDomain" ON "TASK"
   ("WORKBASKET_KEY" ASC, "DOMAIN" DESC) ALLOW REVERSE
   SCANS COLLECT SAMPLED DETAILED STATISTICS;
   COMMIT WORK ;
-- index[5],    3,356MB
   CREATE INDEX "IDX_TaskPorvalue" ON "TASK"
   ("POR_VALUE" ASC, "WORKBASKET_ID" ASC) ALLOW REVERSE
   SCANS COLLECT SAMPLED DETAILED STATISTICS;
   COMMIT WORK ;

-- index[6],   15,224MB
   CREATE INDEX "IDX_AttachmentTaskId" ON "ATTACHMENT"
...
-- index[9],    1,056MB
   CREATE UNIQUE INDEX "IDX_WorkbasketId"
   ON "WORKBASKET" ("ID" ASC) INCLUDE ("ORG_LEVEL_4",
   ...
   COMMIT WORK ;
-- index[10],    1,274MB
   CREATE UNIQUE INDEX "IDX_WorkbasketKeyDomain"
   ON "WORKBASKET" ("KEY" ASC, "DOMAIN" ASC)
   ...
   COMMIT WORK ;
-- index[12],    0,325MB
CREATE UNIQUE INDEX "IDX_WorkbasketKeyDomainWithId"
   ON "WORKBASKET" ("KEY" ASC, "DOMAIN" ASC)
   INCLUDE ("ID") ALLOW REVERSE SCANS COLLECT SAMPLED DETAILED STATISTICS;
COMMIT WORK ;

-- index[4],    0,126MB
CREATE INDEX "IDX_WorkbasketacceslistWithAccessId" ON "WORKBASKET_ACCESS_LIST"
   ("ACCESS_ID" ASC, "WORKBASKET_ID" ASC, "PERM_READ"
   ASC) ALLOW REVERSE SCANS COLLECT SAMPLED DETAILED STATISTICS;
COMMIT WORK ;
-- index[13],    0,126MB
   CREATE INDEX "IDX_WorkbasketAccesList" ON "WORKBASKET_ACCESS_LIST"
