...
-- index[1],    0,013MB
   ...
   COMMIT WORK ;
-- index[2],    3,646MB
   CREATE INDEX "DB2ADMIN"."IDX1805212018000" ON "TASK"
   ("WORKBASKET_KEY" ASC, "DOMAIN" DESC) ALLOW REVERSE
   SCANS COLLECT SAMPLED DETAILED STATISTICS;
   COMMIT WORK ;
-- index[3],    0,056MB
   CREATE INDEX "DB2ADMIN"."IDX1805212018030" ON "CLASSIFICATION"
   ...
   COMMIT WORK ;
-- index[4],    0,126MB
   CREATE INDEX "DB2ADMIN"."IDX1805212020000" ON "WORKBASKET_ACCESS_LIST"
   ("ACCESS_ID" ASC, "WORKBASKET_ID" ASC, "PERM_READ"
   ASC) ALLOW REVERSE SCANS COLLECT SAMPLED DETAILED STATISTICS;
   COMMIT WORK ;
-- index[5],    3,356MB
   CREATE INDEX "DB2ADMIN"."IDX1805212021410" ON "TASK"
   ("POR_VALUE" ASC, "WORKBASKET_ID" ASC) ALLOW REVERSE
   SCANS COLLECT SAMPLED DETAILED STATISTICS;
   COMMIT WORK ;
-- index[6],   15,224MB
   CREATE INDEX "DB2ADMIN"."IDX1805212021430" ON "ATTACHMENT"
   ("TASK_ID" ASC) ALLOW REVERSE SCANS COLLECT SAMPLED DETAILED STATISTICS;
   COMMIT WORK ;
-- index[7],    2,353MB
   CREATE INDEX "DB2ADMIN"."IDX1805212024540" ON "ATTACHMENT"
...
-- index[12],    0,325MB
   ...
   COMMIT WORK ;
-- index[13],    0,126MB
   CREATE INDEX "DB2ADMIN"."IDX1805212042430" ON "WORKBASKET_ACCESS_LIST"
