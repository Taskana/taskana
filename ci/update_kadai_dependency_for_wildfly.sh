...
#H   the kadai dependency in our wildfly example project will be incremented to the new version.
#H
#H i:
...
function main() {
  ...
  if [[ "$GITHUB_REF" =~ ^refs/tags/v[0-9]+\.[0-9]+\.[0-9]+$ ]]; then
    ...
    FILES=(
      "$REL/../rest/kadai-rest-spring-example-wildfly/src/test/java/io/kadai/example/wildfly/AbstractAccTest.java"
    )
