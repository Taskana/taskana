...
public class MonitorController {
   ...
   *
   * <p>A Workbasket Report contains the total numbers of tasks, clustered by the a Task Timestamp
   ...
   *
   * <p>A Task Status Report contains the total number of tasks, clustered in their TaskStates and
   * grouped by Workbaskets. Each row represents a Workbasket while each column represents a
   * TaskState.
   *
