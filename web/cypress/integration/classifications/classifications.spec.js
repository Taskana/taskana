context("TASKANA Classifications", () => {
  it("should be able to visit Classifications and filter by manual", () => {
    cy.visit(
      Cypress.env("baseUrl") + Cypress.env("adminUrl") + "/classifications"
    );

    cy.get("#dropdown-classification-filter")
      .click()
      .then(() => {
        cy.get('[type="button"][title="MANUAL"]').click();

        cy.get("tree-node-collection")
          .find("tree-node")
          .should("have.length", 2);
      });
  });

  it("should be possibile to edit the Name of a classification", () => {
    cy.visit(
      Cypress.env("baseUrl") + Cypress.env("adminUrl") + "/classifications"
    );
  ...
  it("should be possibile to edit the Priority of a classification", () => {
    cy.visit(
      Cypress.env("baseUrl") + Cypress.env("adminUrl") + "/classifications"
    );
    cy.contains(Cypress.env("testValueClassificationSelectionName")).click();
  ...
  it("should be possibile to edit the Category of a classification", () => {
    cy.visit(
      Cypress.env("baseUrl") + Cypress.env("adminUrl") + "/classifications"
    );
    cy.contains(Cypress.env("testValueClassificationSelectionName")).click();
    ...
    cy.get(".dropdown-menu > li.ng-tns-c14-3")
      .contains("PROCESS")
      .click();
    ...
    cy.get(".dropdown-menu > li.ng-tns-c10-3 > :nth-child(1)")
      .contains("EXTERNAL")
      .should("be.visible")
      .click();
  ...
  it("should be possibile to edit the Description of a classification", () => {
    cy.visit(
      Cypress.env("baseUrl") + Cypress.env("adminUrl") + "/classifications"
    );
    cy.contains(Cypress.env("testValueClassificationSelectionName")).click();
    ...
    cy.get("#classification-description")
      .clear()
      .type(editedValue);
  ...
  it("should be possibile to edit the Service Level of a classification", () => {
    cy.visit(
      Cypress.env("baseUrl") + Cypress.env("adminUrl") + "/classifications"
    );
    cy.contains(Cypress.env("testValueClassificationSelectionName")).click();
    ...
    cy.get("#classification-service-level")
      .clear()
      .type(editedValue);
  ...
  it("should be possibile to edit classification custom 1 to 8", () => {
    cy.visit(
      Cypress.env("baseUrl") + Cypress.env("adminUrl") + "/classifications"
    );
    cy.contains(Cypress.env("testValueClassificationSelectionName")).click();
    ...
    cy.wrap([1, 2, 4, 5, 6, 7, 8]).each(index => {
      ...
      cy.get("#classification-custom-" + index).should(
        "have.value",
        Cypress.env("testValueClassifications")
      );
    });
  });

  it("should be possibile to edit the application entry point", () => {
    cy.visit(
      Cypress.env("baseUrl") + Cypress.env("adminUrl") + "/classifications"
    );
    cy.contains(Cypress.env("testValueClassificationSelectionName")).click();
    ...
    cy.get("#classification-application-entry-point").should(
      "have.value",
      Cypress.env("testValueClassifications")
    );
  });
